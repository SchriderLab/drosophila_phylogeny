...
all_retictrees("netsC1_score_nets.txt","gene_trees_wboot_dna_mafft","clade1_score")
all_retictrees("netsC2_score_nets.txt","gene_trees_wboot_dna_mafft","clade2_score")
all_retictrees("netsC3_score_nets.txt","gene_trees_wboot_dna_mafft","clade3_score")
all_retictrees("netsC4_score_nets.txt","gene_trees_wboot_dna_mafft","clade4_score")
all_retictrees("netsC5_score_nets.txt","gene_trees_wboot_dna_mafft","clade5_score")
all_retictrees("netsC6_score_nets.txt","gene_trees_wboot_dna_mafft","clade6_score")
all_retictrees("netsC7_score_nets.txt","gene_trees_wboot_dna_mafft","clade7_score")
all_retictrees("netsC8_score_nets.txt","gene_trees_wboot_dna_mafft","clade8_score")
all_retictrees("netsC9_score_nets.txt","gene_trees_wboot_dna_mafft","clade9_score")